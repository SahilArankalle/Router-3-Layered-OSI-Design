...
HD_PWD='C:/Users/Sahil/Desktop/Maven/Project/FIFO/router_fifo_design/router_fifo_design.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log router_fifo_design_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source router_fifo_design_tb.tcl
